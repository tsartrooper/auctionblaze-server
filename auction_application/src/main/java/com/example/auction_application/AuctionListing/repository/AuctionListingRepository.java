package com.example.auction_application.AuctionListing.repository;
...
public interface AuctionListingRepository extends JpaRepository<AuctionListing,Long>, JpaSpecificationExecutor<AuctionListing> {
